...
export const MOCK_PRODUCTS: readonly SourcedProduct[] = [
  {
    ...
    provenance: {
      ...
      areaMinM2: prov(0, "pham_vi", "Dưới 15m²", observed(0), "parse_area_m2@v1"),
      areaMaxM2: prov(0, "pham_vi", "Dưới 15m²", observed(15), "parse_area_m2@v1"),
    },
    observedAt: OBSERVED_AT,
  },
  {
    ...
    provenance: {
      ...
      areaMinM2: prov(1, "pham_vi", "Từ 15 - 20m²", observed(15), "parse_area_m2@v1"),
      areaMaxM2: prov(1, "pham_vi", "Từ 15 - 20m²", observed(20), "parse_area_m2@v1"),
    },
    observedAt: OBSERVED_AT,
  },
  {
    ...
    provenance: {
      ...
      areaMinM2: prov(2, "pham_vi", "Từ 20 - 30m²", observed(20), "parse_area_m2@v1"),
      areaMaxM2: prov(2, "pham_vi", "Từ 20 - 30m²", observed(30), "parse_area_m2@v1"),
    },
    observedAt: OBSERVED_AT,
  },
];
