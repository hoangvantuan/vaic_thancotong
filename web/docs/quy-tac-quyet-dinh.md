...
|---|---|---|
| 1 | Ngành hàng | "Anh/chị đang quan tâm nhóm sản phẩm nào ạ?" |
...
| `decline` | Đủ slot nhưng 0 sản phẩm qua lọc (`no_eligible_product`), ngành không có dữ liệu (`data_unavailable`), hoặc cổng công bố chặn sau một lần sửa (`insufficient_evidence`) |
